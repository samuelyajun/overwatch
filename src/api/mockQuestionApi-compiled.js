...
var generateId = function generateId(question) {
...
var QuestionApi = function () {
    ...
    _createClass(QuestionApi, null, [{
        ...
        value: function deleteQuestion(questionId) {
            return new Promise(function (resolve, reject) {
                setTimeout(function () {
                    var indexOfQuestionToDelete = questions.findIndex(function (question) {
...
//# sourceMappingURL=mockQuestionApi-compiled.js.map